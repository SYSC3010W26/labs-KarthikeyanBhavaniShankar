...
if row is None:
    print("First wind speed entry for this city.")
else:
    previous_speed = row[0]
    if wind_speed > previous_speed:
        print("Wind speed increased.")
    elif wind_speed < previous_speed:
        print("Wind speed decreased.")
    else:
        print("Wind speed stayed the same.")

cursor.execute("""
INSERT INTO Winds (City, Date, WindSpeed)
VALUES (?, ?, ?)
""", (city, current_time, wind_speed))
